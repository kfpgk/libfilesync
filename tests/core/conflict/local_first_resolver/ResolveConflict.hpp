#ifndef LIBFILESYNC_TESTS_CORE_CONFLICT_LOCAL_FIRST_RESOLVER_RESOLVE_CONFLICT_HPP
#define LIBFILESYNC_TESTS_CORE_CONFLICT_LOCAL_FIRST_RESOLVER_RESOLVE_CONFLICT_HPP
