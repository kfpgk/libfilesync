#ifndef LIBFILESYNC_TESTS_CORE_REMOTE_FIRST_FILE_SYNCER_RESOLVE_CONFLICT_HPP
#define LIBFILESYNC_TESTS_CORE_REMOTE_FIRST_FILE_SYNCER_RESOLVE_CONFLICT_HPP
